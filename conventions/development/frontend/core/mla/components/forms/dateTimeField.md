...
> Its full surface → `DateTimeField.vue`.
...
- should reach for it over a [DateField](dateField.md) and [TimeField](timeField.md) pair
...
| Reach for | When |
|---|---|
| [DateField](dateField.md) | the time of day is not part of the value |
| [TimeField](timeField.md) | the day is fixed and only the time is picked |

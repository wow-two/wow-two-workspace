...
- should reach for [Toaster](toaster.md) in product code — it renders this already
...
| Reach for | When |
|---|---|
| [Toaster](toaster.md) | the app fires toasts imperatively and wants one queue |
| [FeedbackToasts](feedbackToasts.md) | the notices are published on the headless bus |
...
- must not add a timer around it — auto-dismiss belongs to [Toaster](toaster.md)

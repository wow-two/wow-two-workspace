...
- must lay out a plan in a pricing table, one card per tier
- must put the call to action in the default slot — the card bakes in no routing
- should mark exactly one tier `featured` across the row

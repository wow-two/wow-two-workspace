...
named first on purpose: without it, the first module-federation or shared-runtime rule lands in `mla/platform/` and
becomes a single-app default every later app inherits by accident.

...
| global attributes | `id` · `class` · `role` · `aria-*` · `data-*` · `tabindex` · `hidden` | [global attributes](global-attributes.md) |
...
- must reach for a `@wow-two-beta/ui` component before a raw element — the library already made the choice
  ([constructs](../../../mla/constructs/constructs.md) · [catalog](../../../mla/constructs/component-catalog.md)).

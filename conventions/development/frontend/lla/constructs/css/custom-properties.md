...
- must let a consuming app override a token by re-declaring the same name ([styling](../../../mla/platform/styling.md)).
...
- [styling](../../../mla/platform/styling.md) — how an app overrides the defaults

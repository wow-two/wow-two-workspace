...
- must treat `banned` as never written, and must find its replacement in the same group's § *Banned*.
...
- [styling](../../mla/platform/styling.md) — how an app wires Tailwind and consumes the tokens

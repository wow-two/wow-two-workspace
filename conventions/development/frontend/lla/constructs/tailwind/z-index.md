...
- must let the SDK's overlay components own their own tier ([catalog](../../../mla/constructs/component-catalog.md)).
...
- [catalog](../../../mla/constructs/component-catalog.md) — the overlays that already own a tier

...
- **a `@theme` block outside `bootstrap/`** — reach for the bootstrap stylesheet
  ([architecture](../../../mla/architecture/architecture.md)); tokens declared beside a component are order-dependent,
...
- [styling](../../../mla/platform/styling.md) — the wiring order and the `@source` depth

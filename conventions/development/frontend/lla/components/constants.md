...
- must JSDoc every exported constant with a one-liner `/** … */` ([documentation](../notation/documentation/documentation.md)); include units / range when not obvious — `(px)`, `(0..1 extent)`.
- an internal (unexported) constant uses `/** @internal … */`.

## See also

- [enums](enums.md) — the value-**set** sibling · [extensions](extensions.md) — `{Noun}Extensions` helper objects · [naming](../notation/naming/naming.md)

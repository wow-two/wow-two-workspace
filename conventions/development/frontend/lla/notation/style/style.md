...
The TS counterpart of [../backend/code-organization.md](../../../../backend/dotnet/lla/notation/style/style.md). File-per-type and one-component-per-folder live in [naming](../naming/naming.md) / [components](../../../mla/components/components.md); this file covers in-file layout.
...
Components: imports → types → constants → helpers → component → sub-components (see [components](../../../mla/components/components.md)). Non-component modules: imports → types → constants → exported members.

## See also

- [naming](../naming/naming.md) · [components](../../../mla/components/components.md)

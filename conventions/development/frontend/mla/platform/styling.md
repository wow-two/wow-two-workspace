...
Components with multiple visual states define their class map with **`tailwind-variants`** in a co-located `*.variants.ts` / `*Styles.ts` file (see [naming](../../lla/notation/naming/naming.md)) — keep large variant maps out of the JSX.
...
- [components](../components/components.md) — variants, props

...
- group order and intra-group sort → [../code-style/imports.md](../../../lla/notation/style/imports.md).
...
- must keep a doc a **one-liner**; the six-condition exception is in [documentation](../../../lla/notation/documentation/documentation.md) § The multi-line exception.
- must keep a non-JSDoc `/* */` comment to **one line** stating a role — no exception at all.
- must not restate a rule from this file at a use site → [documentation](../../../lla/notation/documentation/documentation.md) § Scope.
- verb table for everything else → [documentation](../../../lla/notation/documentation/documentation.md).
...
- must name a **constant** PascalCase, never `SCREAMING_SNAKE` → [constants](../../../lla/components/constants.md).
...
[documentation](../../../lla/notation/documentation/documentation.md) § Scope carries a test a reviewer can apply in one pass.

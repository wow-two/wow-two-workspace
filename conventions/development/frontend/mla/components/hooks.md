...
Custom hooks encapsulate state, lifecycle, and operations. Data-fetching hooks own the API call + mapping (see [state-and-data.md](../domains/data/state-and-data.md)).

## Naming

- **Always prefix `use`** — `useAuth`, `useSupplyListings`.
- **Name the resource or action, not the noun** — `useFilterOptions`, not `useFilters`.
- File is PascalCase (`UseSupplyListings.ts`), export is camelCase (`useSupplyListings`) — see [naming](../../lla/notation/naming/naming.md).
...
- [state-and-data.md](../domains/data/state-and-data.md) — the API client these wrap
- [documentation](../../lla/notation/documentation/documentation.md) — verb table · [naming](../../lla/notation/naming/naming.md)

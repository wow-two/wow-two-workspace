...
- must return a disposer from a context subscription ([hooks](../../constructs/hooks.md) § *Lifecycle rules*).
...
- [provider](../../constructs/provider.md) — the kind that installs the client for a subtree

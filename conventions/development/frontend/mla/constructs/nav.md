...
- must take the wayfinding shape's own word bare — `Breadcrumb` · `Pagination` · `CommandPalette`.
...
- [routing](../domains/routing/routing.md) — the route table a nav's destinations point at

...
- must be one of two or more parts, or it folds back into the root ([architecture](../architecture/architecture.md)).
...
- must be exported both flat and attached as `Root.Panel` ([architecture](../architecture/architecture.md)).
...
- [architecture](../architecture/architecture.md) — the compound root and subpart export rules

...
- must carry no route ([routing](../domains/routing/routing.md)); a bookmarkable place is a [page](page.md).
...
- [routing](../domains/routing/routing.md) — why an action stays routeless and a place does not

...
[documentation/summary.md](../../lla/documentation/summary.md), with entity-specific conventions below.
...
- `/// <summary>` starts with **"Gets or sets the {property}"** — bare, because the value is the entity's own. Name a referent only when it
  belongs to something else, as a foreign key does ([documentation.md](../../lla/documentation.md) § *Name the referent*)
...
```csharp
/// <summary>Gets or sets the collection of search URLs.</summary>
...
- `sealed record` — see [models.md](../../lla/models.md)
...
- **Collections** — always `List<T>` (see [models.md](../../lla/models.md) for the three patterns)
...
- See [enums.md](enum.md) for enum mapping

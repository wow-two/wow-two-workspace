...
- [settings.md](../../../components/settings.md) — bind `Issuer`/`Audience`/key from config + secret store, not literals
- [result-pattern.md](../../../constructs/data/result.md) — surface auth failures as `AppError`, not thrown exceptions, in app code

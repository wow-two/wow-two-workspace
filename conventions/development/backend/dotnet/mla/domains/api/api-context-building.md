...
- never read these in a handler - caller context is sourced at the edge and rides the application request ([mediator](../../domains/messaging/mediator/mediator.md))

---

## Usage

- source the context, then pass it explicitly into the mapping - `request.ToCommand(currentUser.Id)` ([api messages](../../domains/api/api-messages.md))

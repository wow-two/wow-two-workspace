...
> Purpose — the same schema is read two ways, and each way brings its own rules; the schema stays out of both.
> Use case — writing a query, mapping a result, or choosing which path a feature takes.
...
| Dapper | an open connection and hand-written SQL, untracked | [dapper](dapper/dapper.md) |

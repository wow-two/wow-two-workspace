...
- **Assembly scans** (mediator handlers, FluentValidation validators) anchor on a **public marker type in
  ...
  ([mediator](../../../../core/mla/domains/messaging/mediator/mediator.md)). Add one empty
...
Every [settings](../../../../core/mla/components/settings.md) record binds in `HostConfiguration.AddSettings()`.

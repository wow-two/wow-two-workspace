...
A component states its folder **name** once ([components](../../../../core/mla/components/components.md) § *Adding a component*);
...
Which layer declares an [entity](../../../../core/mla/constructs/data/entity.md) or an [enum](../../../../core/mla/components/enums.md) is the
